...
def getColumn(ticker_file, info_file, prefix, index, output_base_dir):
  tickers = set(utils.readTickers(ticker_file))
  ...
  logging.info('preparing output dirs')
