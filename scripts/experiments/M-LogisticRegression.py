...
base_dir = '/Users/lnyang/lab/qd/data/experiments/M'
...
for perc in percs:
  for C in Cs:
    # Train model.
    model_def = ('LogisticRegression(C=%f, max_iter=%d)' % (C, max_iter))
    model_file = '%s/LogisticRegression-%f-%f-%d' % (model_dir, perc, C, max_iter)
