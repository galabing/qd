...
def collect(folder, min_date='0000-00-00', max_date='9999-99-99'):
  ...
  exp_dir = '/Users/lnyang/lab/qd/data/experiments/J'
  folder_dir = '%s/%s' % (exp_dir, folder)

  ticker_file = '%s/tickers' % data_dir
  gain_dir = '%s/egains10R3000/1' % data_dir
...
collect('validate', min_date='2011-02-01', max_date='2012-12-31')
collect('test', min_date='2013-02-01')
