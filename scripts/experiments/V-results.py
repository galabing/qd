...
exp_dir = '/Users/lnyang/lab/qd/data/experiments/V'
...
versions = [12, 24, 48, 72, 96, -1]  # model versions (training period in months)
window = 6  # window of prediction in months
