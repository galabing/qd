...
base_dir = '/Users/lnyang/lab/qd/data/experiments/V'
...
# earliest date is 2004-01 => earliest yyyymm is 200412 predicting 200506
# latest is 2014-05 => latest yyyymm is 201311 predicting 201405
# try 12, 24, 36, 48, inf (-1); for earlier years data may not be available
first_ym = '200412'
last_ym = '201311'
months = [12, 24, 48, 72, 96, -1]
